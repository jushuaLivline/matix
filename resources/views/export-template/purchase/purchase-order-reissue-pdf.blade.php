...
<body>
    <table style="font-family: 'Noto Sans JP', 'Arial', sans-serif;vertical-align:center">
        <tbody>
        <tr>
        ...
        <tr class="txtbold" style="margin:0px">
            ...
            <td></td>
            <td colspan="2"></td>
            <td colspan="4" style="font-size: 14pt;">メイティックス 株式会社 <label style="margin-left: 5px; font-size: 12pt; padding:0px; vertical-align: middle">総務課</label></td>
        ...
        <?php
            $formatCellPartNumber = !empty($data->part_number) ? $data->part_number: '';
            $formatCellPartNumber .= !empty($data->product_name) ? '・' . $data->product_name: '';
            $formatCellPartNumber .= !empty($data->standard) ? '・' . $data->standard: '';
        ?>
        <tr class="text-center">
            <td style="border:1px solid #000; text-align:center; vertical-align: middle;"><?php echo $data->requisition_number?></td>
            <td style="border:1px solid #000; text-align:center; vertical-align: middle;"><?php echo $data->line->line_name ?? ''?></td>
            <td style="border:1px solid #000; text-align:center; vertical-align: middle;"><?php echo $formatCellPartNumber?></td>
            <td style="border:1px solid #000; text-align:center; vertical-align: middle;"><?php echo $data->quantity?></td>
            <td style="border:1px solid #000; text-align:center; vertical-align: middle;"><?php echo $data->unit->name ?? ''?></td>
            ...
            <td style="border:1px solid #000; text-align:center; vertical-align: middle;"><?php echo $data->remarks?></td>
        </tr>
