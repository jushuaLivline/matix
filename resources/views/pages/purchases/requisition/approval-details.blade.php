...
@section('content')
    <div class="content">
        <div class="contentInner">
            ...
            @if(session('success'))
                <div class="tableWrap borderLesstable" style="background-color: #fff;">
                    <div class="success">
                        {{ session('success') }}
                    </div>
                </div>
                ...
                <div class="box mb-3 mt-4">
                    ...
                    <div class="mb-4 d-flex">
                        <div class="mr-3">
                            ...
                            <div class="d-flex">
                                <input type="text" name=""
                                       id="" style="margin-right: 10px; width: 500px"
                                       class="text-left"
                    ...
                    <div class="mb-2 d-flex">
                        <div class="mr-3">
                            ...
                            <form id="remove_approval_form" action="{{ route('purchase.purchaseRemoveApprovalUser') }}" method="POST">
                                @csrf
                                <div class="d-flex">
                                        ...
                                        <tbody>
                                            <tr height="100">
                                                @foreach ($purchaseRecord->approvals as $approval)
                                                    ...
                                                    <td width="150" class="approval-row">
                    ...
                    <div class="mb-2 d-flex">
                        <form action="{{ route("purchase.purchaseRequisitionDenied", $purchaseRecord->requisition_number) }}"  method="POST" id="deny-form">
                            @csrf
                    ...
                    <form action="{{ route("purchase.purchaseAddApprovalUser") }}" method="POST" class="with-js-validation  @if($last_approver?->approver_employee_code != Auth::user()->employee_code)d-none @endif" id="addNewApproverForm">
                        @csrf
                        <div class="mb-2 d-flex">
                            <div class="mr-3">
                ...
                <div class="btnListContainer">
                    <div class="btnContainerMain justify-content-flex-end">
                        <div class="btnContainerMainRight">
                            <a href="{{ route("purchase.purchaseRequisitionApprovalSearch", $request) }}" type="button" class="btn btn-blue btn-primary">
                            一覧に戻る
                            </a>
                    ...
                    <form id="approve-form" action="{{ route("purchase.purchaseRequisitionApprove", [$purchaseRecord->requisition_number, ... $requestParams]) }}" method="POST">
                        @csrf
                    </form>
                </div>
    </div>
...
@push('scripts')
    @vite(['resources/js/purchase/requisitions/approval-details.js'])
@endpush
