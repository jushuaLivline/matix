                ...
                <div class="box mb-3">
                    ...
                    <div class="mb-2 d-flex">
                        ...
                        <div class="mr-4">
                            ...
                            <div class="d-flex">
                                ...
                                <input type="text" readonly id="machine_name1" name="machine_name1" value="{{ request()->get('machine_name1') }}" style="margin-right: 10px; width: 335px;">
                                ...
                                <input type="text" readonly id="machine_name2" name="machine_name2" value="{{ request()->get('machine_name2') }}" style="margin-right: 10px; width: 335px;">
                                <button type="button" class="btnSubmitCustom js-modal-open search-btn text-white"
                        ...
                        <div class="mr-3">
                            ...
                            <div class="d-flex">
                                <input type="text" id="line_code_start" 
                                        ...
                                        data-error-messsage-container="#line_code"
                            ...
                            <div data-error-messsage="line_code"></div>
                        </div>
                    </div>
                    ...
                    <div class="mb-2 d-flex">
                        ...
                        <div class="mr-3">
                            ...
                            <div class="d-flex">
                                <input type="text" name="expense_item1" id="expense_item_start" class="text-left"
                                    ...
                                    minlength="3"
                                    onkeypress="return event.charCode >= 48 && event.charCode <= 57"
                                    value="{{ request()->get('expense_item1') }}"
                                    style="margin-right: 10px; width: 80px" required>
                                <button type="button" class="btnSubmitCustom js-modal-open"
                                ...
                                <input type="text" name="expense_item2" id="expense_item_end" class="text-left"
                                    data-error-messsage-container="#expense_item"
                                    data-validate-exist-model="Item" 
                                    data-validate-exist-column="expense_item"
                                    data-inputautosearch-model="Item" 
                                    ...
                                    minlength="3"
                                    onkeypress="return event.charCode >= 48 && event.charCode <= 57"
                                    value="{{ request()->get('expense_item2') }}"
                                    style="margin-right: 10px; width: 80px" required>
                                <button type="button" class="btnSubmitCustom js-modal-open"
                        ...
                        <div class="mr-3">
                            ...
                            <div class="d-flex">
                                <input type="text" id="part_number_start" 
                                    ...
                                    class="w-190c mr-10c" value="{{ request()->get('part_number_start') }}">
                                <button type="button" class="btnSubmitCustom js-modal-open search-btn text-white"
                                ...
                                <input type="text" id="part_number_end" 
                                    ...
                                    data-inputautosearch-return="name_abbreviation"
                                    data-inputautosearch-reference="product_name"
                                    class="w-190c mr-10c" value="{{ request()->get('part_number_end') }}">
                                <button type="button" class="btnSubmitCustom js-modal-open search-btn text-white"
                    ...
                    <div class="mb-2 d-flex">
                        ...
                        <div class="mr-3">
                            ...
                            <div class="d-flex">
                                @include('partials._date_picker', ['inputName' => 'input_date_start', 'inputClass' =>'wi-150c', 'attributes' => 'data-error-messsage-container=#request_error_message1'])
                                <span style="font-size:24px; padding:5px 10px;">
                                    ~
                                </span>
                                @include('partials._date_picker', ['inputName' => 'input_date_end', 'inputClass' =>'wi-150c', 'attributes' => 'data-error-messsage-container=#request_error_message1'])
                            </div>
                    ...
                    <div class="d-flex justify-content-center  position-relative mt-5">
                        ...
                        <a href="{{ route('purchase.history.export', request()->all()) }}" class="position-absolute right-0 btn btn-success">検索結果をEXCEL出力</a>
                    </div>
                ...
                <div class="mb-2">
                    ...
                    <table class="table table-bordered text-center table-striped-custom">
                        ...
                        <tr>
                            ...
                            <th rowspan="2">製品品番</th>
                            <th rowspan="2">品名</th>
                            <th rowspan="2">数量</th>
                            <th rowspan="2">単位</th>
                            <th rowspan="2">単価</th>
                            <th rowspan="2">金額</th>
                            <th rowspan="2">伝票種類</th>
                        ...
                        <tbody>
                            ...
                            <tr data-purchase-record="{{ $data->purchase_record_no}}">
                                ...
                                <td class="tA-cn" style="vertical-align: middle">{{ $data->slip_no }}</td>
                                <td class="tA-le" style="width:200px;">
                                    <div class="d-flex">
                                        @if (in_array($data->purchase_category, [1, 2]))
                                            <a href="{{ route('purchase.history.edit', ['history' => $data->id]) }}?purchase_category={{ $data->purchase_category }}" class="buttonBasic bColor-ok me-2 mr-2">
                                                編集
                                            </a>
                                            <a href="{{ route('purchase.history.duplicate', $data->id) }}?purchase_category={{ $data->purchase_category }}" class="buttonBasic bColor-ok me-2 mr-2">
                                                複写
                                            </a>
                                        @endif
                                        <form action="{{ route('purchase.history.destroy', $data->id) }}" method="POST">
                                            @csrf 
                                            @method('DELETE')
                                            <button type="submit" onclick="return confirm('購入実績を削除します、よろしいでしょうか？');" class="btn btn-orange bColor-ok">
                                                削除
                                            </button>
                                        </form>
                                    </div>
                        ...
                        <tfoot>
                            <tr>
                                <td class="tA-ri" colspan="6" style="border-bottom: none;"></td>
                                <td class="tA-ri" style="font-weight: bold; background-color: #d9e1f2;">合計</td>
                                <td class="tA-ri">{{ $datas ? number_format($datas->sum('amount_of_money'), 0, '', ',') : 0 }}</td>
                                <td class="tA-ri" colspan="3" style="border-bottom: none;"></td>
                            </tr>
                        </tfoot>                                            
                    </table>
                    @if ($datas)
...
@endsection
@push('scripts')
@vite(['resources/js/purchase/history/purchase_history.js'])
@endpush