...
@section('content')
    <div class="content">
        <div class="contentInner">
            ...
            <form id="form_request" class="overlayedSubmitForm with-js-validation" action="{{ route('purchase.history.update', $id) }}" method="POST" accept-charset="utf-8">
                @csrf
                @method('PUT')
                   ...
                   <div class="mb-4 d-flex">
                       <div class="mr-3">
                           ...
                           <div class="d-flex">
                               <p class="formPack radioSale">
                                   <label class="radioBasic">
                                       <input type="radio" name="tax_classification" value="1" {{ ($data?->tax_classification ?? 1) == 1 ? 'checked' : '' }} required>
                                       <span>課税</span>
                                   </label>
                               </p>
                               <p class="formPack radioSale">
                                   <label class="radioBasic">
                                       <input type="radio" name="tax_classification" value="2" {{ ($data?->tax_classification ?? 1) == 2 ? 'checked' : '' }}>
                                       <span>非課税</span>
                                   </label>
                               </p>
                           </div>
