...
@section('content')
    <div class="content">
        <div class="contentInner">
            ...
            <div class="section">
                <form action="{{ route('master.masterLine.store') }}" id="lineMasterForm" class="overlayedSubmitForm with-js-validation" method="POST" accept-charset="utf-8"
                    data-confirmation-message="行番号マスタを登録させていただきます。よろしいでしょうか？">
                    @csrf                    
                    ...
                    <table class="tableBasic tableWrap bordered mb-3">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="px-1 ml-1 mt-2 mb-2 d-flex">
                                        <input type="checkbox" name="delete_flag" value="1" {{ $line?->delete_flag == 1 ? 'checked' : '' }}>
                                        <div class="err_msg w-100 ml-2 mt-2"></div>
                                    </div>
                                </td>
                            </tr>
...
@endsection
@push('scripts')
    @vite(['resources/js/master/line/create.js'])
@endpush