...
@php
    ...
    $purchase_category = $data?->purchase_category ?? request()->get('purchase_category');

    $categoryName = $purchase_category == 1 ? '生産品' : '購買品';
    $confirmation_message = $purchase_category == 1 ? '購買品購入実績情報を登録します、よろしいでしょうか？' : '生産品購入実績情報を登録します、よろしいでしょうか？';
...
@section('content')
    <div class="content">
        <div class="contentInner">
            ...
            <form id="form_request" class="overlayedSubmitForm with-js-validation" action="{{ route('purchase.purchaseActual.store') }}" method="POST" accept-charset="utf-8"
            data-confirmation-message="{{ $confirmation_message }}">
                @csrf
                @method('POST')
                <input type="hidden" name="purchase_category" value="{{ $data?->purchase_category }}">
                            ...
                            <div class="d-flex">
                                <p class="formPack radioSale">
                                    <label class="radioBasic">
                                        <input type="radio" name="voucher_class" value="1" {{($data?->voucher_class ?? 1) == 1 ? 'checked' : ''}}>
                                        <span>購入</span>
                                    </label>
                                </p>
                                <p class="formPack radioSale">
                                    <label class="radioBasic">
                                        <input type="radio" name="voucher_class" value="6" {{($data?->voucher_class ?? 1) == 6 ? 'checked' : ''}}>
                                        <span>修正・返品</span>
                                    </label>
                                </p>
                                <p class="formPack radioSale">
                                    <label class="radioBasic">
                                        <input type="radio" name="voucher_class" value="9" {{($data?->voucher_class ?? 1) == 9 ? 'checked' : ''}}>
                                        <span>値引</span>
                                    </label>
                                </p>
                            </div>
                        ...
                        <div class="mr-3">
                            ...
                            <div class="d-flex">
                                <input type="text" name="supplier_code"
                                       id="supplier_code"
                                       data-field-name="仕入先"
                                       data-error-messsage-container="#customer_code_error"
                            ...
                            <div id="customer_code_error"></div>
                        </div>
                    </div>
                                   ...
                                   <label class="radioBasic">
                                       <input type="radio" 
                                        ...
                                        data-error-messsage-container="#tax_classification_error"
                                         value="1" {{ ($data?->tax_classification ?? 1) == 1 ? 'checked' : '' }} required>
                                       <span>課税</span>
                                   </label>
                               </p>
                               <p class="formPack radioSale">
                                   <label class="radioBasic">
                                       <input type="radio"
                                            ...
                                            data-field-name="課税区分"
                                            data-error-messsage-container="#tax_classification_error"
                                            value="2" {{ ($data?->tax_classification ?? 1) == 2 ? 'checked' : '' }}>
                                       <span>非課税</span>
                                   </label>
                               </p>
                           </div>
                   ...
                   <div class="mb-4">
                       ...
                       <div class="d-flex">
                           <input type="text" name="project_code" id="project_code" class="text-left mr-10c"
                               ...
                               class="text-left" 
                               maxlength="8"
                               style="width: 120px;" value="{{ $data?->project_code }}">
                       ...
                       <div class="mr-3">
                           ...
                           <div class="d-flex">
                               <textarea rows="5" cols="100" 
                                 ...
                                 type="text" name="remarks" id="remarks" value="" class=""
