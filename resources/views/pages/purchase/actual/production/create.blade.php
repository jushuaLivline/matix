...
@section('title', "生産品購入実績入力")

@section('content')
    <div class="content">
        <div class="contentInner">
            <div class="accordion">
                <h1><span>生産品購入実績入力 </span></h1>
            </div>
            ...
            <form id="form_request" class="overlayedSubmitForm with-js-validation" action="{{  route('purchase.purchaseProduction.store') }}" method="POST" accept-charset="utf-8"
                data-confirmation-message="生産品購入実績情報を登録します、よろしいでしょうか？">
                @csrf
                              ...
                              <p class="formPack radioSale">
                                  <label class="radioBasic">
                                      <input type="radio" name="slip_type" value="1"
                                          {{ (request()->get('slip_type') ?? 1) == 1 ? 'checked' : '' }}>
                                      <span>納入伝票</span>
                                  </label>
                              </p>
                              <p class="formPack radioSale">
                                  <label class="radioBasic">
                                      <input type="radio" name="slip_type" value="2"
                                          {{ (request()->get('slip_type') ?? 1) == 2 ? 'checked' : '' }}>
                                      <span>外注加工伝票</span>
                                  </label>
                              </p>
                              <p class="formPack radioSale">
                                  <label class="radioBasic">
                                      <input type="radio" name="slip_type" value="3"
                                          {{ (request()->get('slip_type') ?? 1) == 3 ? 'checked' : '' }}>
                                      <span>購入材伝票</span>
                                  </label>
                              </p>
                          </div>
