...
@section('content')
    <div class="content">
        <div class="contentInner">
            ...
            @php
                $route = route('purchase.purchaseProduction.update', ['id' => $id]);
            @endphp
            <form id="form_request" class="overlayedSubmitForm with-js-validation" action="{{ $route }}" method="POST" accept-charset="utf-8">
                @csrf
                @method('PUT')
                            ...
                            <div class="d-flex">
                                <p class="formPack radioSale">
                                    <label class="radioBasic">
                                        <input type="radio" name="voucher_class" value="1" {{($data?->voucher_class == 1) ? 'checked' : ''}}>
                                        <span>購入</span>
                                    </label>
                                </p>
                                <p class="formPack radioSale">
                                    <label class="radioBasic">
                                        <input type="radio" name="voucher_class" value="6" {{($data?->voucher_class == 6) ? 'checked' : ''}}>
                                            <span>修正・返品</span>
                                    </label>
                                </p>
                                <p class="formPack radioSale">
                                    <label class="radioBasic">
                                        <input type="radio" name="voucher_class" value="9" {{($data?->voucher_class == 9) ? 'checked' : ''}}>
                                            <span>値引</span>
                                    </label>
                                </p>
                            </div>
               ...
               <div class="btnListContainer">
                   <div class="btnContainerMain justify-content-flex-end">
                       <div class="btnContainerMainRight">
                           ...
                           <button type="submit" class="btn btn-green" id="submit_button" onclick="return confirm('購入実績を更新します、よろしいでしょうか？');">
                               この内容で更新する
                           </button>
                       </div>
                   </div>
