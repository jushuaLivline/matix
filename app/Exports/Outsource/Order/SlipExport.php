...
namespace App\Exports\Outsource\Order;
...
class SlipExport implements FromCollection, WithHeadings, WithMapping, ShouldAutoSize, WithStyles
{
    ...
    public function map($outsourcedProcess): array
    {
        ...
        return [
            ...
            "\t ". optional($outsourcedProcess->product)->part_number ?? '（該当なし）',
