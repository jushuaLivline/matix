...
use App\Services\Material\Order\InspectionService;
use App\Http\Requests\Material\Order\InspectionRequest;
...
class InspectionController extends Controller
{
  ...
  public function index(Request $request)
  {
    ...
    return view('pages.material.order.inspection.index', compact('recentSupplyArrivals'));
  }

  public function store_session(InspectionRequest $request)
  {
